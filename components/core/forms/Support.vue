<template>
	<div class="form-support plain-form form-line form-no-label" v-bind:key="keys.element">
		<div v-bind:class="container" v-if="form">
			<app-component-form-form 
				v-bind:id="`forms${ page }-${ page }-${ form.slug }-form`" 
...
<script>
	...
	export default {
		...
		computed: {
			...
			form () {
				return get(this.forms, this.formname);
			},
			forms () {
		...
		mounted () {
			if (window.DEBUG) console.log("debug - app.components.core.forms.Support.mounted");
		}
	}
</script>